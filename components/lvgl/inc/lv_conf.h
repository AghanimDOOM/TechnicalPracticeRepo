 ...
 */
#define LV_DRAW_THREAD_STACK_SIZE    (100 * 1024)   /*[bytes]*/
...
#define LV_CACHE_DEF_SIZE       (100*1024)
...
#define LV_USE_FS_STDIO 1
    ...
    #define LV_FS_STDIO_CACHE_SIZE (100*1024)    /*>0 to cache this number of bytes in lv_fs_read()*/
#endif
